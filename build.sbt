...
ThisBuild / organization := "com.github.gvaatstra"

ThisBuild / organizationName := "gatling-prometheus-datawriter"
ThisBuild / organizationHomepage := Some(url("https://github.com/gvaatstra/gatling-prometheus-datawriter"))

ThisBuild / scmInfo := Some(
    ScmInfo(
        url("https://github.com/gvaatstra/gatling-prometheus-datawriter"),
        "scm:git@github.com/gvaatstra/gatling-prometheus-datawriter.git"
    )
)
...
ThisBuild / homepage := Some(url("https://github.com/gvaatstra/gatling-prometheus-datawriter"))
...
val gatling                        = "io.gatling"                           % "gatling-core"                    % "3.3.1"
